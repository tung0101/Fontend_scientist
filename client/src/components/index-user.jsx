    ...
    <div className=" flex mt-20 text-white">
      <div className="flex-2 mr-10 mt-10 ">
        <div className="flex  ml-28 mb-4 ">
          <div className=" bg-my-color rounded-lg custom-css bg-[#2F3338]">
            <img
            ...
            <div className="ml-2.5 mt-2.5">
              ...
              <span className="font-normal text-sm opacity-50 whitespace-nowrap leading-normal">
                USA MERA,PhD.12/31/20225 min read
                <br />
          ...
          <div className="grid-cols-1 ml-5 ">
            <div className="flex bg-my-color h-50 w-auto mb-5 rounded-lg bg-[#2F3338]">
              <img
            ...
            <div className="flex bg-my-color h-40 w-auto mb-5 rounded-lg  bg-[#2F3338]">
              <img
        ...
        <div className=" ml-28 ">
          <div className="grid-cols-1   ">
            <div className="flex bg-my-color h-48 w-auto mb-5 rounded-lg bg-[#2F3338]">
              <img
